 ...
 *     description: Check if a username/email is available for registration
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     description: Revoke all active sessions for a specific user (Admin only)
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *                 message:
 *                   type: string
 *                   example: "All sessions revoked for user"
 *       400:
